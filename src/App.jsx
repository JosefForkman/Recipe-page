...
function App() {
    return (
        <main>
            ...
            <section className="bg-RoseWhite" aria-labelledby="Preparation">
                <h2 className="text-Nutmeg" id="Preparation">Preparation time</h2>
            ...
            <section aria-labelledby="Ingredients">
                <h2 className="text-Nutmeg" id="Ingredients">Ingredients</h2>
            ...
            <section aria-labelledby="Instructions">
                <h2 className="text-Nutmeg" id="Instructions">Instructions</h2>
            ...
            <section aria-labelledby="Nutrition">
                <h2 className="text-Nutmeg" id="Nutrition">Nutrition</h2>
